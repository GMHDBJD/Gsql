...
{
  stream >> column_schema.data_type >> column_schema.not_null >> column_schema.null_default >> column_schema.unique >> column_schema.default_value >> column_schema.reference_table_name >> column_schema.reference_column_name;
  return stream;
}
...
{
  return getSize(column_schema.data_type) + getSize(column_schema.not_null) + getSize(column_schema.null_default) + getSize(column_schema.unique) + getSize(column_schema.default_value) + getSize(column_schema.reference_table_name) + getSize(column_schema.reference_column_name);
}
